...
const { default: _makeWaSocket, makeWALegacySocket } = (await import('@whiskeysockets/baileys')).default
...
console.log(`\n⚠️ SIN CONEXIÓN, BORRE LA CARPETA ${`session`} ⚠️\n`)
...
return (global.opts['legacy'] ? makeWALegacySocket : _makeWaSocket)(connectionOptions)
}